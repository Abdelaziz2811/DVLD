...
namespace DVLD_DAL.Applications.Licenses
{
    public static class clsDetainedLicense_DAL
    {
        public static DataTable LoadDetainedLicenses()
        {
            ...
            string query = @"SELECT DetainID, (People.FirstName + ' ' + People.LastName) AS Name,
                             People.NationalNo, DetainedLicenses.LicenseID, DetainDate, FineFees, DetainedLicenses.CreatedByUserID,
                             IsReleased, ReleaseDate, ReleasedByUserID, ReleaseApplicationID FROM DetainedLicenses
