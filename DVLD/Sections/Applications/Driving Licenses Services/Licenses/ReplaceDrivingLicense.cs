...
namespace DVLD.Sections.Applications.Driving_Licenses_Services.Licenses
{
    ...
    {
        clsApplications_BLL ReplaceApplication;
        ...
        private void TC_LicenseApplication_SelectedIndexChanged(object sender, EventArgs e)
        {
            if (TC_LicenseApplication.SelectedTab.Text == "Application Info")
            {
                ...
                else
                {
                    ...
                    ReplaceApplication = new clsApplications_BLL();
                    SetApplicationInfo();
        ...
        void SetApplicationInfo()
        {
            ...
            {
                ReplaceApplication.PaidFees = clsApplicationTypes_BLL.Find(4).ApplicationFees;
                ReplaceApplication.ApplicationTypeID = 4;
            }
            else
            {
                ReplaceApplication.PaidFees = clsApplicationTypes_BLL.Find(3).ApplicationFees;
        ...
        void SetControlsProperties()
        {
            ...
            GB_ReplacementType.Enabled = false;
        }
