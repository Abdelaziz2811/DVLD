...
namespace DVLD.Sections.Applications.Driving_Licenses_Services.Licenses
{
    ...
    {
        clsApplications_BLL ReleaseApplication;
        ...
        {
            if (LB_DetainID.Text != "??" && !BTN_Release.Enabled)
            {
                TC_ReleaseLicense.SelectedTab = TP_ReleaseInfo;
                return;
            }
        ...
        private void TC_ReleaseLicense_SelectedIndexChanged(object sender, EventArgs e)
        {
            if (TC_ReleaseLicense.SelectedTab.Text == "Release Info")
            {
                ...
                {
                    ReleaseApplication = new clsApplications_BLL();
                    SetApplicationInfo();

                    DetainedLicense = clsDetainedLicenses_BLL.Find(Convert.ToInt32(UC_LicenseSelector.UC_LicenseInfo.LB_LicenseID.Text));
        ...
        void SetApplicationInfo()
        {
            ...
            ReleaseApplication.PaidFees = clsApplicationTypes_BLL.Find(5).ApplicationFees;
