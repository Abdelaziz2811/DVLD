...
namespace DVLD.Sections.Tests
{
    public partial class ManageTestTypes : Form
    {
        ...
        void LoadTestTypes()
        {
            DGV_TestTypes.DataSource = clsTestTypes_BLL.GetTestTypes();
        }
        ...
        {
            clsTestTypes_BLL TestType = clsTestTypes_BLL.Find(Convert.ToInt32(DGV_TestTypes.CurrentRow.Cells[0].Value));
            if (TestType != null)
            {
