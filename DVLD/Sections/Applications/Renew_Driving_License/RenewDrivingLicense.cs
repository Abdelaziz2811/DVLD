...
namespace DVLD.Sections.Applications.Driving_Licenses_Services.Licenses
{
    ...
    {
        clsApplication_BLL RenewalApplication;
            ...
            if (TC_LicenseApplication.SelectedTab.Text == "Application Info")
            {
                ...
                else
                {
                    ...
                    else
                    {
                        ...
                        RenewalApplication = new clsApplication_BLL();
                        SetApplicationInfo();
        ...
        void SetApplicationInfo()
        {
            ...
            RenewalApplication.PaidFees = clsApplicationType_BLL.Find(2).ApplicationFees;
            ...
            if (clsLicense_BLL.FindByLicenseID(License.LicenseID) == null)
            {
                ...
                if (RenewalApplication.Save())
                {
                    ...
                    if (License.Save())
                    {
                        ...
                        UC_LicenseSelector.UC_LicenseInfo.LoadLicenseInfo(Convert.ToInt32(LB_ExpiredLicenseID.Text));
                    }
                }
            }
            else
        ...
        {
            clsLicenseClass_BLL LicenseClass = clsLicenseClass_BLL.Find(UC_LicenseSelector.UC_LicenseInfo.LB_Class.Text);
        ...
        void SetLicenseInfo_ToSave()
        {
            ...
            License.IssueDate = DateTime.Now;
            License.ExpirationDate = DateTime.Now.AddYears(clsLicenseClass_BLL.Find(UC_LicenseSelector.UC_LicenseInfo.LB_Class.Text).DefaultValidityLength); ;
