...
namespace DVLD.Sections.Applications.Driving_Licenses_Services.New_Driving_License.Test_Appointments
{
    public partial class TestAppointments : Form
    {
        ...
        clsApplication_BLL Application;
        enTestType TestType;
        public TestAppointments(clsLocalLicenseApplication_BLL LocalLicenseApplication, enTestType TestType)
        {
            ...
            this.Application = clsApplication_BLL.Find(clsLocalLicenseApplication_BLL.Find(LocalLicenseApplication.LocalDrivingLicenseApplicationID).ApplicationID);
        ...
        void LoadTestAppointments()
        {
            switch (TestType)
            {
                case enTestType.VisionTest:
                    DGV_TestAppointments.DataSource = clsTestAppointment_BLL.LoadTestAppointments(enTestType.VisionTest, LocalLicenseApplication.LocalDrivingLicenseApplicationID);
                    break;
                case enTestType.WrittenTest:
                    DGV_TestAppointments.DataSource = clsTestAppointment_BLL.LoadTestAppointments(enTestType.WrittenTest, LocalLicenseApplication.LocalDrivingLicenseApplicationID);
                    break;
                case enTestType.StreetTest:
                    DGV_TestAppointments.DataSource = clsTestAppointment_BLL.LoadTestAppointments(enTestType.StreetTest, LocalLicenseApplication.LocalDrivingLicenseApplicationID);
                    break;
            }
        }
        ...
        void LoadLocalLicenseApplicationInfo()
        {
            ...
            UC_LicenseApplicationInfo.LB_ApplicationType.Text = clsApplicationType_BLL.Find(Application.ApplicationTypeID).ApplicationTypeTitle;
        ...
        {
            if (clsTestAppointment_BLL.Exists(TestType, LocalLicenseApplication.LocalDrivingLicenseApplicationID))
            ...
            {
                if (clsTest_BLL.IsPass(TestType, Convert.ToInt32(UC_LicenseApplicationInfo.LB_LDLAppID.Text)))
                {
                ...
                clsTestAppointment_BLL TestAppointments = new clsTestAppointment_BLL();
        ...
        {
            clsTestAppointment_BLL TestAppointments = clsTestAppointment_BLL.Find(Convert.ToInt32(DGV_TestAppointments.CurrentRow.Cells[0].Value));
