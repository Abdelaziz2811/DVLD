...
namespace DVLD.Sections.Applications.Driving_Licenses_Services.New_Driving_License.Test_Appointments
{
    public partial class TakeTest : Form
    {
        ...
        public TakeTest(UC_LicenseApplicationInfo LicenseApplicationInfo, enTestType TestType, clsTestAppointment_BLL TestAppointments)
        {
            InitializeComponent();
        ...
        void LoadTestAppointmentInfo()
        {
            ...
            UC_TestDetails.LB_Trial.Text = clsTestAppointment_BLL.TrialCount(TestType, Convert.ToInt32(LicenseApplicationInfo.LB_LDLAppID.Text)).ToString();
