...
namespace DVLD.Sections.Applications.Driving_Licenses_Services.New_Driving_License.Local_License
{
    public partial class IssueLicense_FirstTime : Form
    {
        ...
        {
            clsDriver_BLL Driver;
            if (!clsDriver_BLL.IsExists(Person.PersonID))
            {
                Driver = new clsDriver_BLL();
                SetDriverInfo(ref Driver);
                Driver.Save();
            }
            else
                Driver = clsDriver_BLL.FindByPersonID(Person.PersonID);
        ...
        void SetDriverInfo(ref clsDriver_BLL Driver)
        {
        ...
        void SetLicenseInfo(ref clsLicense_BLL License, clsDriver_BLL Driver)
        {
            clsLicenseClass_BLL LicenseClass = clsLicenseClass_BLL.Find(UC_LicenseApplicationInfo.LB_LicenseClass.Text);
