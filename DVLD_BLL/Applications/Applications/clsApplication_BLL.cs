...
namespace DVLD_BLL.Applications.Applications
{
    ...
    public class clsApplication_BLL
    {
        ...
        clsApplication_BLL(int ApplicationID, int ApplicantPersonID, DateTime ApplicationDate, int ApplicationTypeID, byte ApplicationStatus,
        ...
        public static clsApplication_BLL Find(int ApplicationID)
        { 
            ...
            {
                return new clsApplication_BLL(ApplicationID, ApplicantPersonID, ApplicationDate, ApplicationTypeID, ApplicationStatus,
                LastStatusDate, PaidFees, CreatedByUserID);
            }
            else return null;
        }
