...
namespace DVLD_BLL.Applications.TestAppointments
{
    ...
    public class clsTest_BLL
    {
        ...
        clsTest_BLL(int TestID, int TestAppointmentID, bool TestResult, string Notes, int CreatedByUserID)
        {
            this.TestID = TestID;
        ...
        private bool _Add()
        {
            TestID = clsTest_DAL.Add(TestAppointmentID, TestResult, Notes, CreatedByUserID);
        ...
        {
            return clsTest_DAL.Update(TestID, TestAppointmentID, TestResult, Notes, CreatedByUserID);
        }
        ...
        {
            return clsTest_DAL.IsPass((int)TestTypeID, LocalDrivingLicenseApplicationID);
        }
    }
}
